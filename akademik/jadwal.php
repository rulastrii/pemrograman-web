...
<body>
    ...
    <div class="actions">
        <a href="add_jadwal.php" class="btn btn-add"><i class="fas fa-plus"></i> Tambah Jadwal</a>
    </div>
        ...
        function displayData() {
            ...
            paginatedData.forEach(row => {
                ...
                tr.innerHTML = ` 
                    ...
                    <td>${row.dosen}</td>
                    <td>
                        <a href='edit_jadwal.php?id=${row.id}' class='btn btn-edit'><i class="fas fa-edit"></i> Edit</a> |
                        <a href='delete_jadwal.php?id=${row.id}' class='btn btn-danger' onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash"></i> Hapus</a>
                    </td>`;
